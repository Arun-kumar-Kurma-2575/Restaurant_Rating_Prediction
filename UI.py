...
# city = st.selectbox('🏙️ Select the City:', city_option)
# city_encoded = city_option.index(city)
...
rating = st.slider("Give your rating (0 to 5 stars):", min_value=0, max_value=5, value=0)
...
st.markdown("""
    ...
    <div style="text-align: center; font-size: 14px; color: #000000;">
        Created with ❤️ for Foodies | Powered by Machine Learning 🍔
    </div>
    """, unsafe_allow_html=True)
